...
// ── Tools ────────────────────────────────────────────────────────────
    items[1000] = {1000, "Copper Pickaxe", ItemType::Tool,   ToolType::Pickaxe, 0, 2, ASSET_PATH "Assets/Sprites/copper_pickaxe.png", false, 0.0f, TileBreakType::None, 0, 0.0f, 55, 1.0f, 0,  1};
